...
function App() {
  ...
  const claimNFTs = () => {
    ...
    blockchain.smartContract.methods
      ...
      .then((receipt) => {
        console.log(receipt);
        setFeedback(
          `Awesome, ${CONFIG.NFT_NAME} is yours! go visit Opensea.io to view it.`
        );
        setClaimingNft(false);
  ...
  return (
    ...
    style={{
      background: "#EFEFBB",
      background: "-webkit-liniar-gradient(to right, #D4D3DD, #EFEFBB)",
      ...
      >
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 24 }} test>
          <s.Container flex={1} jc={"center"} ai={"center"}>
            <StyledImg alt={"viking"} src={nftGifImage} />
          </s.Container>
          <s.SpacerLarge />
          <s.Container
            flex={2}
          ...
          >
            ...
            >
              {data.totalSupply/*.toString().padStart(4, '0')*/} / {CONFIG.MAX_SUPPLY}
            </s.TextTitle>
            <s.TextDescription
              style={{
                textAlign: "center",
            ...
            {Number(data.totalSupply) >= CONFIG.MAX_SUPPLY ? (
              ...
              <>
                ...
                <s.SpacerXSmall />
                <s.TextDescription
                  style={{ textAlign: "center", color: "var(--accent-text)", fontSize: "18px", marginTop: "-15px"}}
                >
                  Excluding gas fees
                </s.TextDescription>
                <s.SpacerSmall />
